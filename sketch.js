...
function draw(){
  ...
  if (gamestate===start){
    ...
    fill(48,22,8)
    textSize(50)
    text("Fruit Master",width/2-120,height/2-100)
    if (touches.length>0){
      gamestate=play
      score=0;
      touches=[]
...
function spawnfruit1(){
  if (frameCount%60===0){
    fruits=createSprite(-60,410,50,50);
...
function spawnfruits2(){
  if (frameCount%70===0){
    fruit2=createSprite(-60,410,50,50);
...
function spawnfruits3(){
  if (frameCount%90===0){
    fruit3=createSprite(width+10,410,50,50);
...
function spawnfruits4(){
  if (frameCount%110===0){
    fruit4=createSprite(width+10,410,50,50);
...
function spawnalien(){
  if (frameCount%40===0){
    alien=createSprite(width+10,410,50,50);
    alien.scale=0.5;
...
function spawnalien2(){
  if (frameCount%40===0){
    alien2=createSprite(-60,410,50,50);
    alien2.scale=0.5;
